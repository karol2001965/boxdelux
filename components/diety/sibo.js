...
// import Sibo2 from '../../photo_diety/sibo2.jpg'
// import Sibo3 from '../../photo_diety/sibo3.jpg'
        ...
        return (
            ...
            <main class="container_all">
                <section className="margins makro_container">
                    <h2 className="makro_header">Średni rozkład makroskładników w Sibo Delux</h2>
                    <div className="makro">
                    <div>
                        <h2>20%</h2>
                        <p>białko</p>
