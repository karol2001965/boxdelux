...
import Vege2 from '../../photo_diety/vege2.jpg'
import Vege3 from '../../photo_diety/vege3.jpg'
        ...
        return (
            ...
            <main class="container_all">
                <section className="margins makro_container">
                    <h2 className="makro_header">Średni rozkład makroskładników w Vege Delux</h2>
                    <div className="makro">
                    <div>
                        <h2>20%</h2>
                        <p>białko</p>
                ...
                <section className="diet margins">
                    ...
                    <div class="REMOVE">
                        ...
                        <h2> Dieta Vege Delux</h2>
                        <p>
                        Nasza dieta wegetariańska jest przeznaczona dla osób, które chcą wyeliminować mięso ze swojej jadłospisu. Posiłki, które znajdziecie w Vege Delux są różnorodne, smaczne i przede wszystkim – zdrowe! Odpowiednie ilości oraz proporcje składników odżywczych, takich jak: białka, tłuszcze, węglowodany, witaminy, minerały, sprawiają, że dieta Vege Delux jest odpowiednio zbilansowana. Nie pozostawia ona uczucia głodu, wręcz przeciwnie – uczucie sytości, ale nie ciężkości. Dieta wegetariańska ma pozytywny wpływ na samopoczucie, ogólną kondycję organizmu i nasze zdrowie, a ponadto pozwala zmniejszyć ryzyko zachorowania na cukrzycę, nowotwory i choroby serca.
                     </p>
                    </div>

                    <div className="REMOVE"> <img src={Vege2} /></div>
                </section>
                <section className="diet margins">
                    ...
                    <div className="REMOVE"> <img src={Vege3} /></div>
